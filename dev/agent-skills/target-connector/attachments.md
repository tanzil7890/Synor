...
- `python/synor/connectors/postgres/_target.py` — `_VectorIndexHandler`, `_SqlCommandHandler`, `_RowHandler.attachment()`, `TableTarget.declare_vector_index()`, `TableTarget.declare_sql_command_attachment()`
