...
import synor as syn
from synor.resources.id import (
    IdGenerator,
    UuidGenerator,
    generate_id,
    generate_uuid,
...
def test_generate_id_stability() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_generate_id_stability", environment=synor_env),
...
def test_generate_id_different_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_generate_id_different_deps", environment=synor_env),
        _app_main_generate_id,
        deps=["X", "Y"],
    )
...
def test_generate_uuid_stability() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_generate_uuid_stability", environment=synor_env),
...
def test_generate_uuid_different_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_generate_uuid_different_deps", environment=synor_env),
        _app_main_generate_uuid,
        deps=["X", "Y"],
    )
...
def test_id_generator_multiple_ids() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_id_generator_multiple_ids", environment=synor_env),
...
def test_id_generator_stability() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_id_generator_stability", environment=synor_env),
        _app_main_id_generator,
        deps=["A", "B"],
        count=3,
    )
...
def test_id_generator_different_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_id_generator_different_deps", environment=synor_env),
        _app_main_id_generator,
        deps=["X", "Y"],
        count=2,
    )
...
def test_id_generator_constructor_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_id_generator_constructor_deps", environment=synor_env),
...
def test_uuid_generator_multiple_uuids() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_uuid_generator_multiple_uuids", environment=synor_env),
...
def test_uuid_generator_stability() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_uuid_generator_stability", environment=synor_env),
        _app_main_uuid_generator,
        deps=["A", "B"],
        count=3,
    )
...
def test_uuid_generator_different_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_uuid_generator_different_deps", environment=synor_env),
        _app_main_uuid_generator,
        deps=["X", "Y"],
        count=2,
    )
...
def test_uuid_generator_constructor_deps() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_uuid_generator_constructor_deps", environment=synor_env
        ),
