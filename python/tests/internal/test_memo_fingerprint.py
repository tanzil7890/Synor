...
from synor._internal.function import _apply_memo_key, _normalize_memo_key
from synor._internal.memo_fingerprint import (
    fingerprint_call,
    register_memo_key_function,
    unregister_memo_key_function,
)
from synor._internal.typing import MemoStateOutcome
...
def test_dataclass_override_with_synor_memo_key() -> None:
    """Test that __synor_memo_key__ takes precedence over automatic dataclass handling."""
...
def test_pydantic_override_with_synor_memo_key() -> None:
    """Test that __synor_memo_key__ takes precedence over automatic Pydantic handling."""
    try:
        from pydantic import BaseModel
    except ImportError:
        pytest.skip("pydantic not installed")
...
def test_shook_tag_produces_different_fingerprint_from_hook() -> None:
    """Objects with __synor_memo_state__ use 'shook' tag, changing the fingerprint."""
    ...
    class HookAndState:
        ...
        def __synor_memo_state__(self, prev_state: object) -> MemoStateOutcome:
...
def test_state_methods_collected_from_hook() -> None:
    ...
    from synor._internal.memo_fingerprint import StateFnEntry
...
def test_multiple_state_methods_collected_in_order() -> None:
    class S1:
        ...
        def __synor_memo_state__(self, prev: object) -> MemoStateOutcome:
