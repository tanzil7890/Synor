...
def test_context_key_synor_memo_key() -> None:
    """ContextKey.__synor_memo_key__() returns the key string."""
    some_unique_key = "test_synor_memo_key_unique_77"
    key = ContextKey[int](some_unique_key)
    assert key.__synor_memo_key__() == some_unique_key
