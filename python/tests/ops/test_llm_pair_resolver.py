"""Tests for synor.ops.entity_resolution.llm_resolver.LlmPairResolver.
...
from synor.ops.entity_resolution import CanonicalSide, PairDecision  # noqa: E402
from synor.ops.entity_resolution.llm_resolver import LlmPairResolver  # noqa: E402
...
async def test_llm_happy_path_no_match() -> None:
    ...
    with patch("synor.ops.entity_resolution.llm_resolver._litellm.acompletion", mock):
