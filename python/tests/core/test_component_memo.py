...
def test_source_data_memo() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_source_data_memo", environment=synor_env),
        _declare_dict_data,
    )
...
def test_source_data_memo_cleanup() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_source_data_memo_cleanup", environment=synor_env),
        _declare_dict_data,
    )
...
def test_source_data_memo_use_mount() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_source_data_memo_use_mount", environment=synor_env),
...
def test_source_data_memo_use_mount_cleanup() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_source_data_memo_use_mount_cleanup", environment=synor_env
        ),
        _declare_transform_dict_data,
    )
...
def test_memo_invalidation_on_decorator_change() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_invalidation_on_decorator_change", environment=synor_env
        ),
        app_main,
    )
...
def test_bound_method_memo_with_mount() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_bound_method_memo_mount", environment=synor_env),
        _mount_bound_method,
    )
...
def test_bound_method_memo_with_use_mount() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_bound_method_memo_use_mount", environment=synor_env),
