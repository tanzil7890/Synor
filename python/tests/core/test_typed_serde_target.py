...
_typed_tracking_provider = syn.register_root_target_states_provider(
...
def test_tracking_record_serialize_by_pickle() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_tracking_record_serialize_by_pickle", environment=synor_env
        ),
        _declare_tracking,
    )
...
_typed_record_provider = syn.register_root_target_states_provider(
...
def test_typed_handler_wrapper_deserializes() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_typed_handler_wrapper_deserializes", environment=synor_env
        ),
