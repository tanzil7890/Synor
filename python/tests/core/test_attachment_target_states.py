...
def test_attachment_basic_lifecycle() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_attachment_basic_lifecycle", environment=synor_env),
...
def test_attachment_idempotent_provider() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_attachment_idempotent_provider", environment=synor_env
        ),
        _declare_idempotent,
    )
    app.update_blocking()
...
def test_attachment_independent_types() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_attachment_independent_types", environment=synor_env),
...
def test_attachment_no_support_returns_none() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_attachment_no_support_returns_none", environment=synor_env
        ),
