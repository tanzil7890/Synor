"""Tests for serialization/deserialization in synor._internal.serde."""
...
class TestRejection:
    def test_unregistered_type_rejected(self) -> None:
        from synor._internal.serde import DeserializationError
...
class TestInternalUnpickleSafeGlobal:
    ...
    def test_add_unpickle_safe_global(self) -> None:
        ...
        from synor._internal.serde import _UNPICKLE_SAFE_GLOBALS
