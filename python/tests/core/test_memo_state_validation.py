...
def test_state_validation_sync() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_state_validation_sync", environment=synor_env),
        _process_data,
    )
...
def test_state_validation_async() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_state_validation_async", environment=synor_env),
        _process_data_async,
    )
...
def test_state_validation_component_sync() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_state_validation_component_sync", environment=synor_env
        ),
        _declare_data,
    )
...
def test_state_validation_component_async() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_state_validation_component_async", environment=synor_env
        ),
        _declare_data_async,
    )
...
def test_state_changed_but_reusable_sync() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_state_changed_but_reusable_sync", environment=synor_env
        ),
        _run_two_level,
    )
...
def test_state_changed_but_reusable_async() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_state_changed_but_reusable_async", environment=synor_env
        ),
...
def test_state_changed_but_reusable_component_sync() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_state_changed_but_reusable_comp_sync", environment=synor_env
        ),
        _run_two_level_comp,
    )
