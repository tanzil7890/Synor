...
- __synor_memo_state__ receives typed prev_state on subsequent runs
...
def test_memo_roundtrip_dataclass_return() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_roundtrip_dataclass_return", environment=synor_env
        ),
        _process_dc,
    )
...
def test_memo_roundtrip_pydantic_return() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_roundtrip_pydantic_return", environment=synor_env
        ),
        _process_pydantic,
    )
...
def test_memo_roundtrip_no_type_hint() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_memo_roundtrip_no_type_hint", environment=synor_env),
        _process_nohint,
    )
...
def test_memo_cache_hit_no_double_deserialize() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_cache_hit_no_double_deserialize", environment=synor_env
        ),
        _process_dedup,
    )
...
def test_memo_state_typed_deserialization() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_state_typed_deserialization", environment=synor_env
        ),
        _process_state,
    )
...
def test_memo_state_reuse_with_changed_states() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_state_reuse_with_changed_states", environment=synor_env
        ),
        _process_reuse,
    )
...
def test_memo_roundtrip_forward_reference_return() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_roundtrip_forward_reference_return", environment=synor_env
        ),
        _process_fwd,
    )
...
def test_memo_state_filelike_non_existence_type(tmp_path: pathlib.Path) -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_memo_state_filelike_non_existence", environment=synor_env
        ),
        _process_filelike,
    )
