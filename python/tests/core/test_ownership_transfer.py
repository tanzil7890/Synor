...
def test_ownership_transfer_basic() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_ownership_transfer_basic", environment=synor_env),
        _app_main,
    )
...
def test_ownership_transfer_same_value() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_ownership_transfer_same_value", environment=synor_env),
        _app_main,
    )
...
def test_ownership_transfer_then_delete() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_ownership_transfer_then_delete", environment=synor_env
        ),
        _app_main,
    )
...
def test_ownership_transfer_ordering_independence() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_ownership_transfer_ordering", environment=synor_env),
        _app_main,
    )
...
def test_ownership_transfer_multiple_keys() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_ownership_transfer_multiple_keys", environment=synor_env
        ),
        _app_main,
    )
...
def test_ownership_transfer_chain() -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_ownership_transfer_chain", environment=synor_env),
        _app_main,
    )
...
def test_ownership_transfer_preempt_strict() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_ownership_transfer_preempt_strict", environment=synor_env
        ),
...
def test_component_delete_cleans_inverted_tracking() -> None:
    ...
    app = syn.App(
        syn.AppConfig(
            name="test_component_delete_cleans_inverted", environment=synor_env
        ),
        _app_main,
    )
