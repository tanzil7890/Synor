...
if HAS_SURREALDB:
    from synor.connectors import surrealdb  # type: ignore[attr-defined]
    from synor.connectors.surrealdb._target import (  # type: ignore[import-untyped]
        _format_record_id,
...
if HAS_SURREALDB:
    SURREAL_DB_KEY: syn.ContextKey[Any] = syn.ContextKey("test_surrealdb_target_db")
...
async def test_create_table_schemafull_and_insert(
    ...
    app = syn.App(
        syn.AppConfig(name="test_schemafull_insert", environment=synor_env),
...
async def test_create_table_schemaless_and_insert(
    ...
    app = syn.App(
        syn.AppConfig(name="test_schemaless_insert", environment=synor_env),
...
async def test_update_record(
    ...
    app = syn.App(
        syn.AppConfig(name="test_update_record", environment=synor_env),
        declare_table_and_rows,
    )
...
async def test_delete_record(
    ...
    app = syn.App(
        syn.AppConfig(name="test_delete_record", environment=synor_env),
        declare_table_and_rows,
    )
...
async def test_no_op_when_unchanged(
    ...
    app = syn.App(
        syn.AppConfig(name="test_no_op", environment=synor_env),
        declare_table_and_rows,
    )
...
async def test_drop_table_on_removal(
    ...
    app_with_table = syn.App(
        syn.AppConfig(name="test_drop_table", environment=synor_env),
        declare_table_and_rows,
    )
...
async def test_schema_evolution_add_field(
    ...
    app = syn.App(
        syn.AppConfig(name="test_evolve_add", environment=synor_env),
        declare_table_and_rows,
    )
    await app.update()
...
async def test_schema_evolution_remove_field(
    ...
    app = syn.App(
        syn.AppConfig(name="test_evolve_remove", environment=synor_env),
        declare_table_and_rows,
    )
    await app.update()
...
async def test_schema_evolution_change_id_type(
    ...
    app = syn.App(
        syn.AppConfig(name="test_evolve_id", environment=synor_env),
        declare_table_and_rows,
    )
    await app.update()
...
async def test_relation_basic(
    ...
    app = syn.App(
        syn.AppConfig(name="test_rel_basic", environment=synor_env),
...
async def test_relation_delete(
    ...
    app = syn.App(
        syn.AppConfig(name="test_rel_delete", environment=synor_env),
        declare_with_relations,
    )
...
async def test_relation_without_schema(
    ...
    app = syn.App(
        syn.AppConfig(name="test_rel_schemaless", environment=synor_env),
...
async def test_relation_polymorphic(
    ...
    app = syn.App(
        syn.AppConfig(name="test_rel_poly", environment=synor_env),
        declare_polymorphic,
    )
...
async def test_relation_auto_id_with_update(
    ...
    app = syn.App(
        syn.AppConfig(name="test_auto_id_update", environment=synor_env),
...
async def test_relation_schema_without_id(
    ...
    app = syn.App(
        syn.AppConfig(name="test_rel_no_id_schema", environment=synor_env),
...
async def test_transaction_ordering(
    ...
    app = syn.App(
        syn.AppConfig(name="test_txn_ordering", environment=synor_env),
...
async def test_table_level_ordering(
    ...
    app_create = syn.App(
        syn.AppConfig(name="test_ddl_order", environment=synor_env),
...
async def test_multiple_tables_shared_sink(
    ...
    app = syn.App(
        syn.AppConfig(name="test_shared_sink", environment=synor_env),
        declare_multi,
    )
...
async def test_vector_index_mtree(
    ...
    app = syn.App(
        syn.AppConfig(name="test_vec_mtree", environment=synor_env),
        declare_vec_table,
    )
...
async def test_vector_index_hnsw(
    ...
    app = syn.App(
        syn.AppConfig(name="test_vec_hnsw", environment=synor_env),
        declare_vec_table,
    )
...
async def test_vector_index_update(
    ...
    app = syn.App(
        syn.AppConfig(name="test_vec_update", environment=synor_env),
        declare_vec_table,
    )
...
async def test_user_managed_table(
    ...
    """Test managed_by='user' — Synor manages rows but not the table DDL."""
    conn, ns, db = surreal_conn
    ...
    app = syn.App(
        syn.AppConfig(name="test_user_managed", environment=synor_env),
        declare_schemaless_rows,
    )
...
async def test_schemaless_struct_input(
    ...
    app = syn.App(
        syn.AppConfig(name="test_struct", environment=synor_env),
...
async def test_type_mapping(
    ...
    app = syn.App(
        syn.AppConfig(name="test_types", environment=synor_env),
        declare_types_table,
    )
    await app.update()
