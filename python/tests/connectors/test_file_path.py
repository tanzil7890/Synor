...
from synor.connectors.localfs import FilePath as LocalfsFilePath
...
def test_filepath_no_base_dir_memo_key() -> None:
    ...
    assert fp.__synor_memo_key__() == PurePath("some/file.txt")
...
def test_localfs_has_no_register_base_dir() -> None:
    ...
    import synor.connectors.localfs as localfs
