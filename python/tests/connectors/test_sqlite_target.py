...
SQLITE_DB = syn.ContextKey[sqlite.ManagedConnection]("sqlite_test_db")
...
def test_create_table_and_insert_rows(
    ...
    app = syn.App(
        syn.AppConfig(name="test_create_table_and_insert", environment=test_env),
...
def test_update_row(sqlite_db: tuple[sqlite.ManagedConnection, Path]) -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_update_row", environment=test_env),
        declare_table_and_rows,
    )
...
def test_delete_row(sqlite_db: tuple[sqlite.ManagedConnection, Path]) -> None:
    ...
    app = syn.App(
        syn.AppConfig(name="test_delete_row", environment=test_env),
        declare_table_and_rows,
    )
...
def test_no_change_optimization(
    ...
    app = syn.App(
        syn.AppConfig(name="test_no_change", environment=test_env),
        declare_table_and_rows,
    )
...
def test_user_managed_table(sqlite_db: tuple[sqlite.ManagedConnection, Path]) -> None:
    """Test user-managed table (Synor only manages rows, not DDL)."""
    managed_conn, _ = sqlite_db
...
def test_vec0_without_vector_column_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0NoVectorTest", environment=test_env),
...
def test_vec0_with_composite_pk_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0CompositePkTest", environment=test_env),
        declare_invalid_table,
    )
...
def test_vec0_with_non_integer_pk_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0StringPkTest", environment=test_env),
        declare_invalid_table,
    )
...
def test_vec0_without_extension_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0NoExtTest", environment=test_env),
...
def test_vec0_invalid_partition_key_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0BadPartitionTest", environment=test_env),
        declare_invalid_table,
    )
...
def test_vec0_invalid_auxiliary_column_raises_error(
    ...
    app = syn.App(
        syn.AppConfig(name="Vec0BadAuxTest", environment=test_env),
        declare_invalid_table,
    )
