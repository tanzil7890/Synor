"""
Type stubs for the synor._internal.core Rust extension module (PyO3).
"""
...
class ComponentProcessorContext:
    ...
    def begin_mount_group(
        self,
    ) -> tuple[ComponentProcessorContext, ComponentMountHandle]: ...
    def end_mount_group(self) -> None: ...
...
class AsyncContext:
    def __new__(
        cls, event_loop: asyncio.AbstractEventLoop, callback_owner: int | None = None
    ) -> "AsyncContext": ...
    def acquire_operation(self) -> OperationLease: ...
    def close_operation_admission(self) -> None: ...
    def cancel_live_operations(self) -> None: ...
    def close_callback_admission(self) -> None: ...
    async def drain_operations_async(self) -> None: ...
...
class App:
    ...
    def drop_async(
        self, host_ctx: Any = None, *, operation_lease: OperationLease
    ) -> DropHandle: ...
...
_SinkCapabilitiesTuple: TypeAlias = tuple[
    int, str, str, str, str, str, str, int | None, int | None
]
...
class TargetActionSink:
    ...
    def new_sync(
        ...
        capabilities: _SinkCapabilitiesTuple | None = None,
    ) -> TargetActionSink: ...
    @staticmethod
    def new_async(
    ...
    def capabilities(self) -> _SinkCapabilitiesTuple: ...
    def queue_stats(self) -> _SinkQueueStatsTuple: ...
...
def init_runtime(
    *,
    ...
    enter_environment_callback_fn: Callable[[int], Any],
    exit_environment_callback_fn: Callable[[Any], None],
) -> None: ...
