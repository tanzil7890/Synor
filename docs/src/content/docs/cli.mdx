...
```bash
synor integrity [OPTIONS] COMMAND [ARGS]...
```
...
```bash
synor integrity scan [OPTIONS] COMMAND [ARGS]...
```
...
```bash
synor integrity scan local [OPTIONS] CONFIG_TARGET
```
...
| Option | Description |
|--------|-------------|
| `--output FILE` | New private deterministic JSON report path.  [required] |
| `--help` | Show this message and exit. |
...
```bash
synor native-effects [OPTIONS] COMMAND [ARGS]...
```
...
```bash
synor native-effects compact [OPTIONS]
```
...
| Option | Description |
|--------|-------------|
| `--db DIRECTORY` | Source Synor database directory.  [required] |
| `--app-name TEXT` | Persisted app name.  [required] |
| `--completed-before TEXT` | ISO-8601 cutoff with Z or an explicit UTC offset. [required] |
| `--archive FILE` | New private archive written and fsynced before compaction.  [required] |
| `--confirm-compaction` | Confirm deletion of archived, unreferenced completed evidence. |
| `--json` | Emit result JSON. |
| `--help` | Show this message and exit. |

---

### `native-effects export`
...
```bash
synor native-effects export [OPTIONS]
```
...
| `--db DIRECTORY` | Source Synor database directory.  [required] |
| `--app-name TEXT` | Persisted app name.  [required] |
| `--output FILE` | New private JSON archive path.  [required] |
| `--json` | Emit result JSON. |
| `--help` | Show this message and exit. |

---

### `native-effects prepare-downgrade`
...
```bash
synor native-effects prepare-downgrade [OPTIONS]
```
...
|--------|-------------|
| `--db DIRECTORY` | Source Synor database directory.  [required] |
| `--output-db DIRECTORY` | New downgraded database directory.  [required] |
| `--archive FILE` | New private archive for metadata removed from the copy.  [required] |
| `--confirm-downgrade` | Confirm creation of a pre-native compatibility copy. |
| `--json` | Emit result JSON. |
| `--help` | Show this message and exit. |
