"""
Meeting Notes Graph (v1) — Synor pipeline example.
...
import synor as syn
from synor.connectors import falkordb, google_drive
...
KG_DB = syn.ContextKey[falkordb.ConnectionFactory]("kg_db")
...
app = syn.App(
    syn.AppConfig(name="MeetingNotesGraphFalkorDB"),
    app_main,
)
