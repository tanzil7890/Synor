"""
Multi-Codebase Summarization - Synor Pipeline Example

This example demonstrates a Synor pipeline that:
...
2. For each project, extracts:
   ...
   - Mermaid graphs for Synor app/function call relationships
...
app = syn.App(
    syn.AppConfig(name="MultiCodebaseSummarization"),
    app_main,
    root_dir=pathlib.Path("../"),
