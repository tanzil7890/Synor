"""
HackerNews Trending Topics - Synor pipeline example.
...
# Configuration
DATABASE_URL = os.environ.get("POSTGRES_URL", "postgres://synor:synor@localhost/synor")
MAX_THREADS = 10
...
PG_DB = syn.ContextKey[asyncpg.Pool]("hn_db")
